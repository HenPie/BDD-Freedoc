...
ActiveRecord::Schema.define(version: 2020_10_22_122020) do
  ...
  create_table "joins", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["doctor_id"], name: "index_joins_on_doctor_id"
    t.index ["speciality_id"], name: "index_joins_on_speciality_id"
  end
